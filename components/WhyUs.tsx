...
export default function WhyUs() {
  return (
    <section id="zasto-mi" className="py-24 bg-primary">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-accent mb-4">Zašto Strada 46?</h2>
          <p className="text-white text-lg max-w-2xl mx-auto">
            Kada ostanete bez auta, bitno je koga zovete. Evo zašto nam vozači u Beogradu godinama
            veruju.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="flex gap-4 bg-accent rounded-2xl p-6 border border-primary/40 hover:border-accent/50 transition-colors"
            >
              <div className="flex-shrink-0 w-11 h-11 bg-primary rounded-xl flex items-center justify-center">
                <Icon />
              </div>
              <div>
                <h3 className="text-primary font-bold text-lg mb-2 leading-tight">{title}</h3>
  ...
  return (
    <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M8 18H5a2 2 0 01-2-2v-1M3 10V7a2 2 0 012-2h9a2 2 0 012 2v7m0 0h-3m3 0h1a2 2 0 002-2v-3a2 2 0 00-.586-1.414l-3-3A2 2 0 0016.414 4H15"
      />
