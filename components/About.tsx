      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white mt-3 mb-6">O nama</h2>
            ...
            <p className="text-slate-400 text-lg leading-relaxed mb-10">
              ...
              vozila kako bismo vaše vozilo bezbedno transportovali na željenu adresu.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            {stats.map(({ value, label }) => (
              <div
                key={label}
                className="bg-primary border border-primary/30 rounded-2xl p-8 text-center hover:border-accent/40 transition-colors"
              >
